...
public class FileDialog extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cancelButton = (Button) findViewById(R.id.cancelFileDialog);
    ...
    private void getDirImpl(final String dirPath) {
        ...
        if (!currentPath.equals(ROOT)) {
            ...
            item.add(ROOT);
            addItem(ROOT, R.drawable.ic_newfolder_root);
            path.add(ROOT);

            item.add("..");
            addItem("..", R.drawable.ic_newfolder_top);
        ...
        for (String dir : dirsMap.tailMap("").values()) {
            addItem(dir, R.drawable.ic_newfolder);
        }
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (file.isDirectory()) {
            ...
            if (file.canRead()) {
                ...
                new AlertDialog.Builder(this).setIcon(R.drawable.ic_newfolder)
